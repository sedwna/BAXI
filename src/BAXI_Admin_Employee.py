...
class Ui_BAXI_Admin_Employee(object):
    def setupUi(self, BAXI_Admin_Employee):
        ...
        self.get_first_name_employee_panel_authentication = QtWidgets.QTextEdit(parent=self.employee_panel_authentication_1)
        self.get_first_name_employee_panel_authentication.setGeometry(QtCore.QRect(220, 160, 104, 31))
        self.get_first_name_employee_panel_authentication.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
        self.get_first_name_employee_panel_authentication.setObjectName("get_first_name_employee_panel_authentication")
        self.get_last_name_employee_panel_authentication = QtWidgets.QTextEdit(parent=self.employee_panel_authentication_1)
        self.get_last_name_employee_panel_authentication.setGeometry(QtCore.QRect(40, 160, 141, 31))
        self.get_last_name_employee_panel_authentication.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
        self.get_last_name_employee_panel_authentication.setObjectName("get_last_name_employee_panel_authentication")
        self.get_code_meli_employee_panel_authentication = QtWidgets.QTextEdit(parent=self.employee_panel_authentication_1)
        self.get_code_meli_employee_panel_authentication.setGeometry(QtCore.QRect(220, 240, 104, 31))
        self.get_code_meli_employee_panel_authentication.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
        self.get_code_meli_employee_panel_authentication.setObjectName("get_code_meli_employee_panel_authentication")
        self.get_phone_number_employee_panel_authentication = QtWidgets.QTextEdit(parent=self.employee_panel_authentication_1)
        self.get_phone_number_employee_panel_authentication.setGeometry(QtCore.QRect(45, 325, 131, 31))
        self.get_phone_number_employee_panel_authentication.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
        self.get_phone_number_employee_panel_authentication.setObjectName("get_phone_number_employee_panel_authentication")
        self.get_shaba_number_employee_panel_authentication = QtWidgets.QTextEdit(parent=self.employee_panel_authentication_1)
        self.get_shaba_number_employee_panel_authentication.setGeometry(QtCore.QRect(40, 397, 281, 31))
        self.get_shaba_number_employee_panel_authentication.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
        self.get_shaba_number_employee_panel_authentication.setObjectName("get_shaba_number_employee_panel_authentication")
        self.get_birthday_employee_panel_authentication = QtWidgets.QSpinBox(parent=self.employee_panel_authentication_1)
        self.get_birthday_employee_panel_authentication.setGeometry(QtCore.QRect(140, 245, 42, 22))
        self.get_birthday_employee_panel_authentication.setMinimum(1)
        self.get_birthday_employee_panel_authentication.setMaximum(31)
        self.get_birthday_employee_panel_authentication.setObjectName("get_birthday_employee_panel_authentication")
        self.get_sex_employee_panel_authentication = QtWidgets.QComboBox(parent=self.employee_panel_authentication_1)
        self.get_sex_employee_panel_authentication.setGeometry(QtCore.QRect(232, 324, 81, 31))
        self.get_sex_employee_panel_authentication.setLayoutDirection(QtCore.Qt.LayoutDirection.RightToLeft)
        self.get_sex_employee_panel_authentication.setObjectName("get_sex_employee_panel_authentication")
        self.get_sex_employee_panel_authentication.addItem("")
        self.get_sex_employee_panel_authentication.addItem("")
        self.get_birthmonth_employee_panel_authentication = QtWidgets.QSpinBox(parent=self.employee_panel_authentication_1)
        self.get_birthmonth_employee_panel_authentication.setGeometry(QtCore.QRect(93, 245, 42, 22))
        self.get_birthmonth_employee_panel_authentication.setMinimum(1)
        self.get_birthmonth_employee_panel_authentication.setMaximum(12)
        self.get_birthmonth_employee_panel_authentication.setObjectName("get_birthmonth_employee_panel_authentication")
        self.get_birthyear_employee_panel_authentication = QtWidgets.QSpinBox(parent=self.employee_panel_authentication_1)
        self.get_birthyear_employee_panel_authentication.setGeometry(QtCore.QRect(38, 245, 51, 21))
        self.get_birthyear_employee_panel_authentication.setMinimum(1350)
        self.get_birthyear_employee_panel_authentication.setMaximum(1600)
        self.get_birthyear_employee_panel_authentication.setObjectName("get_birthyear_employee_panel_authentication")
    ...
    def retranslateUi(self, BAXI_Admin_Employee):
        ...
        self.get_sex_employee_panel_authentication.setItemText(0, _translate("BAXI_Admin_Employee", "آقا"))
        self.get_sex_employee_panel_authentication.setItemText(1, _translate("BAXI_Admin_Employee", "خانم"))
