...
class Ui_BAXI(object):
    def setupUi(self, BAXI):
        ...
        self.machine_color_get_machine_baxi_info = QtWidgets.QTextEdit(parent=self.get_machine_baxi_info)
        self.machine_color_get_machine_baxi_info.setGeometry(QtCore.QRect(195, 185, 131, 31))
        self.machine_color_get_machine_baxi_info.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
        self.machine_color_get_machine_baxi_info.setObjectName("machine_color_get_machine_baxi_info")
        self.machine_pelak_get_machine_baxi_info = QtWidgets.QTextEdit(parent=self.get_machine_baxi_info)
        self.machine_pelak_get_machine_baxi_info.setGeometry(QtCore.QRect(30, 200, 131, 31))
        self.machine_pelak_get_machine_baxi_info.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
        self.machine_pelak_get_machine_baxi_info.setObjectName("machine_pelak_get_machine_baxi_info")
        ...
        self.three_digit_pelak_get_machine_baxi_info_2 = QtWidgets.QTextEdit(parent=self.get_machine_baxi_info)
        self.three_digit_pelak_get_machine_baxi_info_2.setGeometry(QtCore.QRect(230, 250, 51, 31))
        self.three_digit_pelak_get_machine_baxi_info_2.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        self.three_digit_pelak_get_machine_baxi_info_2.setObjectName("three_digit_pelak_get_machine_baxi_info_2")
        ...
        self.alphabet_get_machine_baxi_info.addItem("")
        self.alphabet_get_machine_baxi_info.addItem("")
        self.two_digit_left_pelak_get_machine_baxi_info_3 = QtWidgets.QTextEdit(parent=self.get_machine_baxi_info)
        self.two_digit_left_pelak_get_machine_baxi_info_3.setGeometry(QtCore.QRect(120, 250, 31, 31))
        self.two_digit_left_pelak_get_machine_baxi_info_3.setObjectName("two_digit_left_pelak_get_machine_baxi_info_3")
