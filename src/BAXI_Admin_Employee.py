...
class Ui_BAXI_Admin_Employee(object):
    def setupUi(self, BAXI_Admin_Employee):
        ...
        self.pushButt_go_to_employee_panel_authentication_request_employee_panel_authentication_2 = QtWidgets.QPushButton(parent=self.employee_panel_authentication)
        self.pushButt_go_to_employee_panel_authentication_request_employee_panel_authentication_2.setGeometry(QtCore.QRect(214, 521, 111, 41))
        self.pushButt_go_to_employee_panel_authentication_request_employee_panel_authentication_2.setText("")
        self.pushButt_go_to_employee_panel_authentication_request_employee_panel_authentication_2.setFlat(True)
        self.pushButt_go_to_employee_panel_authentication_request_employee_panel_authentication_2.setObjectName("pushButt_go_to_employee_panel_authentication_request_employee_panel_authentication_2")
