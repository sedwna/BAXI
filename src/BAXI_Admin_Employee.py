...
class Ui_BAXI_Admin_Employee(object):
    def setupUi(self, BAXI_Admin_Employee):
        ...
        self.employee_panel_authentication = QtWidgets.QWidget()
        self.employee_panel_authentication.setObjectName("employee_panel_authentication")
        self.label_10 = QtWidgets.QLabel(parent=self.employee_panel_authentication)
        self.label_10.setGeometry(QtCore.QRect(0, 0, 369, 640))
        self.label_10.setText("")
        self.label_10.setPixmap(QtGui.QPixmap("../image/admin_eployee_panel/employee_panel_authentication_1/employee_panel_authentication_1.png"))
        self.label_10.setObjectName("label_10")
        self.pushButt_show_licence_employee_panel_authentication = QtWidgets.QPushButton(parent=self.employee_panel_authentication)
        self.pushButt_show_licence_employee_panel_authentication.setGeometry(QtCore.QRect(252, 460, 75, 31))
        self.pushButt_show_licence_employee_panel_authentication.setText("")
        self.pushButt_show_licence_employee_panel_authentication.setFlat(True)
        self.pushButt_show_licence_employee_panel_authentication.setObjectName("pushButt_show_licence_employee_panel_authentication")
        self.pushButt_show_cart_meli_employee_panel_authentication = QtWidgets.QPushButton(parent=self.employee_panel_authentication)
        self.pushButt_show_cart_meli_employee_panel_authentication.setGeometry(QtCore.QRect(145, 463, 75, 31))
        self.pushButt_show_cart_meli_employee_panel_authentication.setText("")
        self.pushButt_show_cart_meli_employee_panel_authentication.setFlat(True)
        self.pushButt_show_cart_meli_employee_panel_authentication.setObjectName("pushButt_show_cart_meli_employee_panel_authentication")
        self.pushButt_show_sopishine_employee_panel_authentication = QtWidgets.QPushButton(parent=self.employee_panel_authentication)
        self.pushButt_show_sopishine_employee_panel_authentication.setGeometry(QtCore.QRect(40, 464, 75, 31))
        self.pushButt_show_sopishine_employee_panel_authentication.setText("")
        self.pushButt_show_sopishine_employee_panel_authentication.setFlat(True)
        self.pushButt_show_sopishine_employee_panel_authentication.setObjectName("pushButt_show_sopishine_employee_panel_authentication")
        self.pushButt_go_to_employee_panel_authentication_request_employee_panel_authentication = QtWidgets.QPushButton(parent=self.employee_panel_authentication)
        self.pushButt_go_to_employee_panel_authentication_request_employee_panel_authentication.setGeometry(QtCore.QRect(129, 583, 111, 21))
        self.pushButt_go_to_employee_panel_authentication_request_employee_panel_authentication.setText("")
        self.pushButt_go_to_employee_panel_authentication_request_employee_panel_authentication.setFlat(True)
        self.pushButt_go_to_employee_panel_authentication_request_employee_panel_authentication.setObjectName("pushButt_go_to_employee_panel_authentication_request_employee_panel_authentication")
        self.pushButt_go_to_employee_panel_authentication_successful_employee_panel_authentication = QtWidgets.QPushButton(parent=self.employee_panel_authentication)
        self.pushButt_go_to_employee_panel_authentication_successful_employee_panel_authentication.setGeometry(QtCore.QRect(214, 521, 111, 41))
        self.pushButt_go_to_employee_panel_authentication_successful_employee_panel_authentication.setText("")
        self.pushButt_go_to_employee_panel_authentication_successful_employee_panel_authentication.setFlat(True)
        self.pushButt_go_to_employee_panel_authentication_successful_employee_panel_authentication.setObjectName("pushButt_go_to_employee_panel_authentication_successful_employee_panel_authentication")
        self.pushButt_go_to_employee_panel_authentication_employee_panel_authentication = QtWidgets.QPushButton(parent=self.employee_panel_authentication)
        self.pushButt_go_to_employee_panel_authentication_employee_panel_authentication.setGeometry(QtCore.QRect(38, 522, 111, 41))
        self.pushButt_go_to_employee_panel_authentication_employee_panel_authentication.setText("")
        self.pushButt_go_to_employee_panel_authentication_employee_panel_authentication.setFlat(True)
        self.pushButt_go_to_employee_panel_authentication_employee_panel_authentication.setObjectName("pushButt_go_to_employee_panel_authentication_employee_panel_authentication")
        self.pushButt_show_last_name_employee_panel_authentication = QtWidgets.QPushButton(parent=self.employee_panel_authentication)
        self.pushButt_show_last_name_employee_panel_authentication.setGeometry(QtCore.QRect(40, 158, 141, 31))
        self.pushButt_show_last_name_employee_panel_authentication.setText("")
        self.pushButt_show_last_name_employee_panel_authentication.setFlat(True)
        self.pushButt_show_last_name_employee_panel_authentication.setObjectName("pushButt_show_last_name_employee_panel_authentication")
        self.pushButt_show_first_name_employee_panel_authentication = QtWidgets.QPushButton(parent=self.employee_panel_authentication)
        self.pushButt_show_first_name_employee_panel_authentication.setGeometry(QtCore.QRect(216, 159, 111, 31))
        self.pushButt_show_first_name_employee_panel_authentication.setText("")
        self.pushButt_show_first_name_employee_panel_authentication.setFlat(True)
        self.pushButt_show_first_name_employee_panel_authentication.setObjectName("pushButt_show_first_name_employee_panel_authentication")
        self.pushButt_show_birthdate_employee_panel_authentication = QtWidgets.QPushButton(parent=self.employee_panel_authentication)
        self.pushButt_show_birthdate_employee_panel_authentication.setGeometry(QtCore.QRect(40, 240, 141, 31))
        self.pushButt_show_birthdate_employee_panel_authentication.setText("")
        self.pushButt_show_birthdate_employee_panel_authentication.setFlat(True)
        self.pushButt_show_birthdate_employee_panel_authentication.setObjectName("pushButt_show_birthdate_employee_panel_authentication")
        self.pushButt_show_code_meli_employee_panel_authentication = QtWidgets.QPushButton(parent=self.employee_panel_authentication)
        self.pushButt_show_code_meli_employee_panel_authentication.setGeometry(QtCore.QRect(216, 241, 111, 31))
        self.pushButt_show_code_meli_employee_panel_authentication.setText("")
        self.pushButt_show_code_meli_employee_panel_authentication.setFlat(True)
        self.pushButt_show_code_meli_employee_panel_authentication.setObjectName("pushButt_show_code_meli_employee_panel_authentication")
        self.pushButt_show_phone_number_employee_panel_authentication = QtWidgets.QPushButton(parent=self.employee_panel_authentication)
        self.pushButt_show_phone_number_employee_panel_authentication.setGeometry(QtCore.QRect(39, 324, 141, 31))
        self.pushButt_show_phone_number_employee_panel_authentication.setText("")
        self.pushButt_show_phone_number_employee_panel_authentication.setFlat(True)
        self.pushButt_show_phone_number_employee_panel_authentication.setObjectName("pushButt_show_phone_number_employee_panel_authentication")
        self.pushButt_show_sex_employee_panel_authentication = QtWidgets.QPushButton(parent=self.employee_panel_authentication)
        self.pushButt_show_sex_employee_panel_authentication.setGeometry(QtCore.QRect(217, 323, 111, 31))
        self.pushButt_show_sex_employee_panel_authentication.setText("")
        self.pushButt_show_sex_employee_panel_authentication.setFlat(True)
        self.pushButt_show_sex_employee_panel_authentication.setObjectName("pushButt_show_sex_employee_panel_authentication")
        self.pushButt_show_shaba_number_employee_panel_authentication = QtWidgets.QPushButton(parent=self.employee_panel_authentication)
        self.pushButt_show_shaba_number_employee_panel_authentication.setGeometry(QtCore.QRect(42, 397, 281, 31))
        self.pushButt_show_shaba_number_employee_panel_authentication.setText("")
        self.pushButt_show_shaba_number_employee_panel_authentication.setFlat(True)
        self.pushButt_show_shaba_number_employee_panel_authentication.setObjectName("pushButt_show_shaba_number_employee_panel_authentication")
        self.box_fname_employee_panel_authentication = QtWidgets.QPlainTextEdit(parent=self.employee_panel_authentication)
        self.box_fname_employee_panel_authentication.setGeometry(QtCore.QRect(40, 40, 104, 31))
        self.box_fname_employee_panel_authentication.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
        self.box_fname_employee_panel_authentication.setReadOnly(True)
        self.box_fname_employee_panel_authentication.setObjectName("box_fname_employee_panel_authentication")
        self.box_lname_employee_panel_authentication = QtWidgets.QPlainTextEdit(parent=self.employee_panel_authentication)
        self.box_lname_employee_panel_authentication.setGeometry(QtCore.QRect(220, 40, 104, 31))
        self.box_lname_employee_panel_authentication.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
        self.box_lname_employee_panel_authentication.setReadOnly(True)
        self.box_lname_employee_panel_authentication.setObjectName("box_lname_employee_panel_authentication")
        self.stackedWidget.addWidget(self.employee_panel_authentication)
        self.employee_panel_authentication_2 = QtWidgets.QWidget()
        self.employee_panel_authentication_2.setObjectName("employee_panel_authentication_2")
        self.label_11 = QtWidgets.QLabel(parent=self.employee_panel_authentication_2)
        self.label_11.setGeometry(QtCore.QRect(0, 0, 360, 640))
        self.label_11.setText("")
        self.label_11.setPixmap(QtGui.QPixmap("../image/admin_eployee_panel/employee_panel_authentication_2/employee_panel_authentication_2.png"))
        self.label_11.setObjectName("label_11")
        self.pushButt_go_to_employee_panel_authentication_rejected_employee_panel_authentication_2 = QtWidgets.QPushButton(parent=self.employee_panel_authentication_2)
        self.pushButt_go_to_employee_panel_authentication_rejected_employee_panel_authentication_2.setGeometry(QtCore.QRect(125, 524, 111, 41))
        self.pushButt_go_to_employee_panel_authentication_rejected_employee_panel_authentication_2.setText("")
        self.pushButt_go_to_employee_panel_authentication_rejected_employee_panel_authentication_2.setFlat(True)
        self.pushButt_go_to_employee_panel_authentication_rejected_employee_panel_authentication_2.setObjectName("pushButt_go_to_employee_panel_authentication_rejected_employee_panel_authentication_2")
        self.pushButt_go_to_employee_panel_authentication_1_employee_panel_authentication_2 = QtWidgets.QPushButton(parent=self.employee_panel_authentication_2)
        self.pushButt_go_to_employee_panel_authentication_1_employee_panel_authentication_2.setGeometry(QtCore.QRect(130, 582, 101, 31))
        self.pushButt_go_to_employee_panel_authentication_1_employee_panel_authentication_2.setText("")
        self.pushButt_go_to_employee_panel_authentication_1_employee_panel_authentication_2.setFlat(True)
        self.pushButt_go_to_employee_panel_authentication_1_employee_panel_authentication_2.setObjectName("pushButt_go_to_employee_panel_authentication_1_employee_panel_authentication_2")
        self.get_description_employee_panel_authentication_2 = QtWidgets.QTextEdit(parent=self.employee_panel_authentication_2)
        self.get_description_employee_panel_authentication_2.setGeometry(QtCore.QRect(50, 230, 261, 251))
        self.get_description_employee_panel_authentication_2.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
        self.get_description_employee_panel_authentication_2.setObjectName("get_description_employee_panel_authentication_2")
        self.box_fname_employee_panel_authentication_2 = QtWidgets.QPlainTextEdit(parent=self.employee_panel_authentication_2)
        self.box_fname_employee_panel_authentication_2.setGeometry(QtCore.QRect(30, 50, 104, 31))
        self.box_fname_employee_panel_authentication_2.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
        self.box_fname_employee_panel_authentication_2.setReadOnly(True)
        self.box_fname_employee_panel_authentication_2.setObjectName("box_fname_employee_panel_authentication_2")
        self.box_lname_employee_panel_authentication_2 = QtWidgets.QPlainTextEdit(parent=self.employee_panel_authentication_2)
        self.box_lname_employee_panel_authentication_2.setGeometry(QtCore.QRect(220, 50, 104, 31))
        self.box_lname_employee_panel_authentication_2.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
        self.box_lname_employee_panel_authentication_2.setReadOnly(True)
        self.box_lname_employee_panel_authentication_2.setObjectName("box_lname_employee_panel_authentication_2")
        self.stackedWidget.addWidget(self.employee_panel_authentication_2)
        self.employee_panel_authentication_successful = QtWidgets.QWidget()
        self.employee_panel_authentication_successful.setObjectName("employee_panel_authentication_successful")
        self.label_12 = QtWidgets.QLabel(parent=self.employee_panel_authentication_successful)
        self.label_12.setGeometry(QtCore.QRect(0, 0, 360, 640))
        self.label_12.setText("")
        self.label_12.setPixmap(QtGui.QPixmap("../image/admin_eployee_panel/employee_panel_authentication_successful/employee_panel_authentication_successful.png"))
        self.label_12.setObjectName("label_12")
        self.pushButt_go_to_employee_panel_employee_panel_authentication_successful = QtWidgets.QPushButton(parent=self.employee_panel_authentication_successful)
        self.pushButt_go_to_employee_panel_employee_panel_authentication_successful.setGeometry(QtCore.QRect(130, 586, 101, 21))
        self.pushButt_go_to_employee_panel_employee_panel_authentication_successful.setText("")
        ...
        self.box_fname_employee_panel_authentication_successful = QtWidgets.QPlainTextEdit(parent=self.employee_panel_authentication_successful)
        self.box_fname_employee_panel_authentication_successful.setGeometry(QtCore.QRect(30, 50, 104, 31))
        self.box_fname_employee_panel_authentication_successful.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
        self.box_fname_employee_panel_authentication_successful.setReadOnly(True)
        self.box_fname_employee_panel_authentication_successful.setObjectName("box_fname_employee_panel_authentication_successful")
        self.box_lname_employee_panel_authentication_successful = QtWidgets.QPlainTextEdit(parent=self.employee_panel_authentication_successful)
        self.box_lname_employee_panel_authentication_successful.setGeometry(QtCore.QRect(220, 50, 104, 31))
        self.box_lname_employee_panel_authentication_successful.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
        self.box_lname_employee_panel_authentication_successful.setReadOnly(True)
        self.box_lname_employee_panel_authentication_successful.setObjectName("box_lname_employee_panel_authentication_successful")
        ...
        self.box_fname_employee_panel_authentication_rejected = QtWidgets.QPlainTextEdit(parent=self.employee_panel_authentication_rejected)
        self.box_fname_employee_panel_authentication_rejected.setGeometry(QtCore.QRect(30, 50, 104, 31))
        self.box_fname_employee_panel_authentication_rejected.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
        self.box_fname_employee_panel_authentication_rejected.setReadOnly(True)
        self.box_fname_employee_panel_authentication_rejected.setObjectName("box_fname_employee_panel_authentication_rejected")
        self.box_lname_employee_panel_authentication_rejected = QtWidgets.QPlainTextEdit(parent=self.employee_panel_authentication_rejected)
        self.box_lname_employee_panel_authentication_rejected.setGeometry(QtCore.QRect(220, 50, 104, 31))
        self.box_lname_employee_panel_authentication_rejected.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
        self.box_lname_employee_panel_authentication_rejected.setReadOnly(True)
        self.box_lname_employee_panel_authentication_rejected.setObjectName("box_lname_employee_panel_authentication_rejected")
        ...
        self.box_show_fname_admin_panel = QtWidgets.QPushButton(parent=self.admin_panel)
        self.box_show_fname_admin_panel.setGeometry(QtCore.QRect(40, 48, 101, 31))
        self.box_show_fname_admin_panel.setText("")
        self.box_show_fname_admin_panel.setFlat(True)
        self.box_show_fname_admin_panel.setObjectName("box_show_fname_admin_panel")
        self.box_show_lname_admin_panel = QtWidgets.QPushButton(parent=self.admin_panel)
        self.box_show_lname_admin_panel.setGeometry(QtCore.QRect(220, 50, 101, 31))
        self.box_show_lname_admin_panel.setText("")
        self.box_show_lname_admin_panel.setFlat(True)
        self.box_show_lname_admin_panel.setObjectName("box_show_lname_admin_panel")
        ...
        self.get_department_admin_panel_recruitment.setGeometry(QtCore.QRect(242, 350, 111, 31))
        self.get_department_admin_panel_recruitment.setLayoutDirection(QtCore.Qt.LayoutDirection.LeftToRight)
        ...
        self.get_semat_admin_panel_recruitment.setGeometry(QtCore.QRect(110, 350, 131, 31))
        self.get_semat_admin_panel_recruitment.setLayoutDirection(QtCore.Qt.LayoutDirection.LeftToRight)
        ...
        self.get_skill_admin_panel_recruitment.setGeometry(QtCore.QRect(10, 350, 91, 31))
        self.get_skill_admin_panel_recruitment.setLayoutDirection(QtCore.Qt.LayoutDirection.LeftToRight)
        ...
        self.get_birthmonth_admin_panel_recruitment.setGeometry(QtCore.QRect(97, 220, 42, 22))
        ...
        self.get_birthyear_admin_panel_recruitment.setGeometry(QtCore.QRect(34, 220, 61, 22))
        self.get_birthyear_admin_panel_recruitment.setMinimum(1930)
        self.get_birthyear_admin_panel_recruitment.setMaximum(2024)
        self.get_birthyear_admin_panel_recruitment.setProperty("value", 2020)
        self.get_birthyear_admin_panel_recruitment.setObjectName("get_birthyear_admin_panel_recruitment")
        self.box_show_fname_admin_panel_recruitment = QtWidgets.QPushButton(parent=self.admin_panel_recruitment)
        self.box_show_fname_admin_panel_recruitment.setGeometry(QtCore.QRect(40, 50, 101, 31))
        self.box_show_fname_admin_panel_recruitment.setText("")
        self.box_show_fname_admin_panel_recruitment.setFlat(True)
        self.box_show_fname_admin_panel_recruitment.setObjectName("box_show_fname_admin_panel_recruitment")
        self.box_show_lname_admin_panel_recruitment = QtWidgets.QPushButton(parent=self.admin_panel_recruitment)
        self.box_show_lname_admin_panel_recruitment.setGeometry(QtCore.QRect(220, 50, 101, 31))
        self.box_show_lname_admin_panel_recruitment.setText("")
        self.box_show_lname_admin_panel_recruitment.setFlat(True)
        self.box_show_lname_admin_panel_recruitment.setObjectName("box_show_lname_admin_panel_recruitment")
        ...
        self.box_show_fname_admin_panel_query = QtWidgets.QPushButton(parent=self.admin_panel_query)
        self.box_show_fname_admin_panel_query.setGeometry(QtCore.QRect(40, 50, 101, 31))
        self.box_show_fname_admin_panel_query.setText("")
        self.box_show_fname_admin_panel_query.setFlat(True)
        self.box_show_fname_admin_panel_query.setObjectName("box_show_fname_admin_panel_query")
        self.box_show_lname_admin_panel_query = QtWidgets.QPushButton(parent=self.admin_panel_query)
        self.box_show_lname_admin_panel_query.setGeometry(QtCore.QRect(220, 50, 101, 31))
        self.box_show_lname_admin_panel_query.setText("")
        self.box_show_lname_admin_panel_query.setFlat(True)
        self.box_show_lname_admin_panel_query.setObjectName("box_show_lname_admin_panel_query")
        ...
        self.box_show_fname_admin_panel_recruitment_successful = QtWidgets.QPushButton(parent=self.admin_panel_recruitment_successful)
        self.box_show_fname_admin_panel_recruitment_successful.setGeometry(QtCore.QRect(40, 50, 101, 31))
        self.box_show_fname_admin_panel_recruitment_successful.setText("")
        self.box_show_fname_admin_panel_recruitment_successful.setFlat(True)
        self.box_show_fname_admin_panel_recruitment_successful.setObjectName("box_show_fname_admin_panel_recruitment_successful")
        self.box_show_lname_admin_panel_recruitment_successful = QtWidgets.QPushButton(parent=self.admin_panel_recruitment_successful)
        self.box_show_lname_admin_panel_recruitment_successful.setGeometry(QtCore.QRect(220, 50, 101, 31))
        self.box_show_lname_admin_panel_recruitment_successful.setText("")
        self.box_show_lname_admin_panel_recruitment_successful.setFlat(True)
        self.box_show_lname_admin_panel_recruitment_successful.setObjectName("box_show_lname_admin_panel_recruitment_successful")
        ...
        self.pushButt_text_1_employee_panel_authentication_request = QtWidgets.QPushButton(parent=self.employee_panel_authentication_request)
        self.pushButt_text_1_employee_panel_authentication_request.setGeometry(QtCore.QRect(50, 150, 261, 31))
        self.pushButt_text_1_employee_panel_authentication_request.setText("")
        self.pushButt_text_1_employee_panel_authentication_request.setFlat(True)
        self.pushButt_text_1_employee_panel_authentication_request.setObjectName("pushButt_text_1_employee_panel_authentication_request")
        self.pushButt_text_2_employee_panel_authentication_request = QtWidgets.QPushButton(parent=self.employee_panel_authentication_request)
        self.pushButt_text_2_employee_panel_authentication_request.setGeometry(QtCore.QRect(50, 213, 261, 31))
        self.pushButt_text_2_employee_panel_authentication_request.setText("")
        self.pushButt_text_2_employee_panel_authentication_request.setFlat(True)
        self.pushButt_text_2_employee_panel_authentication_request.setObjectName("pushButt_text_2_employee_panel_authentication_request")
        self.pushButt_text_3_employee_panel_authentication_request = QtWidgets.QPushButton(parent=self.employee_panel_authentication_request)
        self.pushButt_text_3_employee_panel_authentication_request.setGeometry(QtCore.QRect(50, 280, 261, 31))
        self.pushButt_text_3_employee_panel_authentication_request.setText("")
        self.pushButt_text_3_employee_panel_authentication_request.setFlat(True)
        self.pushButt_text_3_employee_panel_authentication_request.setObjectName("pushButt_text_3_employee_panel_authentication_request")
        self.pushButt_text_4_employee_panel_authentication_request = QtWidgets.QPushButton(parent=self.employee_panel_authentication_request)
        self.pushButt_text_4_employee_panel_authentication_request.setGeometry(QtCore.QRect(50, 340, 261, 31))
        self.pushButt_text_4_employee_panel_authentication_request.setText("")
        self.pushButt_text_4_employee_panel_authentication_request.setFlat(True)
        self.pushButt_text_4_employee_panel_authentication_request.setObjectName("pushButt_text_4_employee_panel_authentication_request")
        self.pushButt_text_5_employee_panel_authentication_request = QtWidgets.QPushButton(parent=self.employee_panel_authentication_request)
        self.pushButt_text_5_employee_panel_authentication_request.setGeometry(QtCore.QRect(50, 403, 261, 31))
        self.pushButt_text_5_employee_panel_authentication_request.setText("")
        self.pushButt_text_5_employee_panel_authentication_request.setFlat(True)
        self.pushButt_text_5_employee_panel_authentication_request.setObjectName("pushButt_text_5_employee_panel_authentication_request")
        self.pushButt_text_6_employee_panel_authentication_request = QtWidgets.QPushButton(parent=self.employee_panel_authentication_request)
        self.pushButt_text_6_employee_panel_authentication_request.setGeometry(QtCore.QRect(50, 467, 261, 31))
        self.pushButt_text_6_employee_panel_authentication_request.setText("")
        self.pushButt_text_6_employee_panel_authentication_request.setFlat(True)
        self.pushButt_text_6_employee_panel_authentication_request.setObjectName("pushButt_text_6_employee_panel_authentication_request")
        self.pushButt_text_7_employee_panel_authentication_request = QtWidgets.QPushButton(parent=self.employee_panel_authentication_request)
        self.pushButt_text_7_employee_panel_authentication_request.setGeometry(QtCore.QRect(50, 533, 261, 31))
        self.pushButt_text_7_employee_panel_authentication_request.setText("")
        self.pushButt_text_7_employee_panel_authentication_request.setFlat(True)
        self.pushButt_text_7_employee_panel_authentication_request.setObjectName("pushButt_text_7_employee_panel_authentication_request")
        self.box_fname_employee_panel_authentication_request = QtWidgets.QPlainTextEdit(parent=self.employee_panel_authentication_request)
        self.box_fname_employee_panel_authentication_request.setGeometry(QtCore.QRect(30, 50, 104, 31))
        self.box_fname_employee_panel_authentication_request.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
        self.box_fname_employee_panel_authentication_request.setReadOnly(True)
        self.box_fname_employee_panel_authentication_request.setObjectName("box_fname_employee_panel_authentication_request")
        self.box_lname_employee_panel_authentication_request = QtWidgets.QPlainTextEdit(parent=self.employee_panel_authentication_request)
        self.box_lname_employee_panel_authentication_request.setGeometry(QtCore.QRect(220, 50, 104, 31))
        self.box_lname_employee_panel_authentication_request.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
        self.box_lname_employee_panel_authentication_request.setReadOnly(True)
        self.box_lname_employee_panel_authentication_request.setObjectName("box_lname_employee_panel_authentication_request")
        ...
        self.box_fname_employee_panel = QtWidgets.QPlainTextEdit(parent=self.employee_panel)
        self.box_fname_employee_panel.setGeometry(QtCore.QRect(30, 50, 104, 31))
        self.box_fname_employee_panel.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
        self.box_fname_employee_panel.setReadOnly(True)
        self.box_fname_employee_panel.setObjectName("box_fname_employee_panel")
        self.box_lname_employee_panel = QtWidgets.QPlainTextEdit(parent=self.employee_panel)
        self.box_lname_employee_panel.setGeometry(QtCore.QRect(220, 50, 104, 31))
        self.box_lname_employee_panel.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
        self.box_lname_employee_panel.setReadOnly(True)
        self.box_lname_employee_panel.setObjectName("box_lname_employee_panel")
    ...
    def retranslateUi(self, BAXI_Admin_Employee):
        ...
        self.get_sex_admin_panel_recruitment.setItemText(0, _translate("BAXI_Admin_Employee", "M"))
        self.get_sex_admin_panel_recruitment.setItemText(1, _translate("BAXI_Admin_Employee", "F"))
        self.get_department_admin_panel_recruitment.setItemText(0, _translate("BAXI_Admin_Employee", "marketing"))
        self.get_department_admin_panel_recruitment.setItemText(1, _translate("BAXI_Admin_Employee", "accounting"))
        self.get_department_admin_panel_recruitment.setItemText(2, _translate("BAXI_Admin_Employee", "finance"))
        self.get_department_admin_panel_recruitment.setItemText(3, _translate("BAXI_Admin_Employee", "HR"))
        self.get_department_admin_panel_recruitment.setItemText(4, _translate("BAXI_Admin_Employee", "support"))
        self.get_department_admin_panel_recruitment.setItemText(5, _translate("BAXI_Admin_Employee", "development"))
        self.get_semat_admin_panel_recruitment.setItemText(0, _translate("BAXI_Admin_Employee", "department manager"))
        self.get_semat_admin_panel_recruitment.setItemText(1, _translate("BAXI_Admin_Employee", "basic employee"))
        self.get_semat_admin_panel_recruitment.setItemText(2, _translate("BAXI_Admin_Employee", "programmer"))
        self.get_skill_admin_panel_recruitment.setItemText(0, _translate("BAXI_Admin_Employee", "basic"))
        self.get_skill_admin_panel_recruitment.setItemText(1, _translate("BAXI_Admin_Employee", "intermediate"))
        self.get_skill_admin_panel_recruitment.setItemText(2, _translate("BAXI_Admin_Employee", "dvanced"))
        self.get_skill_admin_panel_recruitment.setItemText(3, _translate("BAXI_Admin_Employee", "proficient"))
        self.get_skill_admin_panel_recruitment.setItemText(4, _translate("BAXI_Admin_Employee", "expert"))
